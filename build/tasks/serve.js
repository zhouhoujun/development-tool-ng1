...
StartService = __decorate([development_core_1.task({
    order: function order(total, ctx) {
        return ctx.env.test ? { value: 0.25, runWay: development_core_1.RunWay.parallel } : 1;
    },
    oper: development_core_1.Operation.default | development_core_1.Operation.serve
}), __metadata('design:paramtypes', [Object])], StartService);
